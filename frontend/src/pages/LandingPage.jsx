...
import video from "../../public/PixVerse_V5_Image_Text_360P_Create_a_3060_seco (1).mp4";
import Ushape from "../assets/Ushape.jpeg";
  ...
  const testimonials = [
    {
      ...
      location: "Rajasthan",
      quote:
        "This system saves me 15 minutes every day. More time for teaching, less paperwork!",
      rating: 5,
    },
    {
      name: "Rajesh Kumar",
      ...
      quote:
        "Attendance accuracy improved from 85% to 99%. Government reporting is now seamless.",
      rating: 5,
    },
    {
      name: "Sunita Devi",
      ...
      location: "Bihar",
      quote:
        "Students love the U-shaped seating. Better engagement and no proxy attendance.",
      rating: 5,
    },
  ];
  ...
  const challenges = [
    {
      ...
      strategy:
        "Works with basic smartphones and minimal internet connectivity",
      icon: <Smartphone className="w-6 h-6" />,
    },
    {
      challenge: "Teacher Training Requirements",
      strategy:
        "Simple one-click operation with visual tutorials and local language support",
      icon: <BookOpen className="w-6 h-6" />,
    },
    {
      challenge: "Cost Constraints",
      strategy:
        "Low-cost solution using existing devices, government partnership pricing",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <div className="hidden md:flex space-x-4">
              ...
              <button
                onClick={() => navigate("/schoolAuth")}
                className="px-6 py-2 bg-gradient-to-r from-blue-600 to-green-600 text-white rounded-lg hover:shadow-lg transition-all"
              >
                Get Started
              </button>
            </div>
          ...
          {isMenuOpen && (
            <div className="md:hidden pb-4 space-y-2">
              ...
              <div className="pt-2 space-y-2">
                ...
                <button
                  onClick={() => navigate("/schoolAuth")}
                  className="w-full py-2 bg-gradient-to-r from-blue-600 to-green-600 text-white rounded-lg"
                >
                  Get Started
                </button>
              </div>
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-xl text-gray-600 leading-relaxed">
                  Revolutionary face recognition system that takes attendance in
                  30 seconds with a single photo. Perfect for rural schools with
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Over 50% of rural schools in India struggle with inefficient
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600 leading-relaxed">
                Teachers spend 10-15 minutes daily on manual attendance,
                reducing precious instructional time for millions of students.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600 leading-relaxed">
                Manual systems lead to proxy attendance, data entry errors, and
                inaccurate government reporting for schemes like mid-day meals.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600 leading-relaxed">
                Inaccurate records lead to mismanagement of resources and delays
                in government scheme implementations affecting student welfare.
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="solution" className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Smart U-shaped seating arrangement with instant face recognition
              attendance system
            </p>
          </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Students sit in a curved formation ensuring every face is
                      visible to both teacher and camera, promoting better
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Teacher simply takes one video of the entire class using a
                      smartphone or webcam. No need to call names individually.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Advanced face recognition technology automatically
                      identifies and marks attendance for all students in under
                      30 seconds.
                    </p>
                  </div>
                </div>
      ...
      <section id="benefits" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Experience dramatic improvements in efficiency, accuracy, and
              student engagement
            </p>
          </div>
      ...
      <section id="feasibility" className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Designed specifically for rural schools with practical solutions
              to real challenges
            </p>
          </div>
          ...
          <div className="mt-16 bg-gradient-to-r from-blue-600 to-green-600 rounded-3xl p-8 text-white text-center">
            ...
            <p className="text-lg mb-6 opacity-90">
              Minimal infrastructure • Government partnerships • Proven
              technology • Scalable solution
            </p>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div className="space-y-4">
              ...
              <p className="text-gray-300 leading-relaxed">
                Revolutionizing attendance management for rural schools across
                India with innovative face recognition technology.
              </p>
            </div>
      ...
      {isVideoOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-[100] p-4">
          <div className="relative w-full max-w-4xl aspect-video bg-gray-900 rounded-xl overflow-hidden shadow-2xl">
            ...
            {/* Video player */}
            <video
              src={video} // Make sure to place your video file here
              controls
              autoPlay
